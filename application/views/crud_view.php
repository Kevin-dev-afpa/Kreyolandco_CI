		...
		<div class="col">
			<div class="card" style="width: 13rem;">
				...
				<div class="card-body">
					<h5 class="card-title">Card title</h5>
					<p class="card-text">...</p>
					<a href="#" class="btn btn-primary">Evénement</a>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 13rem;">
				...
				<div class="card-body">
					<h5 class="card-title">Card title</h5>
					<p class="card-text">...</p>
					<a href="#" class="btn btn-primary">Tâche</a>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card" style="width: 13rem;">
				...
				<div class="card-body">
					<h5 class="card-title">Card title</h5>
					<p class="card-text">...</p>
					<a href="#" class="btn btn-primary">Palmarès</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col">
			<div class="card" style="width: 13rem;">
				...
				<div class="card-body">
					<h5 class="card-title">Card title</h5>
					<p class="card-text">...</p>
					<a href="#" class="btn btn-primary">Parcours</a>
				</div>
			</div>
		</div>
</div>
